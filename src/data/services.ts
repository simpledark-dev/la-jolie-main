...
export const services: ServiceCategory[] = [
  {
    ...
    images: [nudeBlushClassic, pearlShimmerNatural],
    items: [
  ...
  },
  {
    ...
    images: [nudeBlushClassic2, pearlShimmerNatural2],
    items: [
  ...
  },
  {
    ...
    images: [pastelAuroraChrome, frenchButterflyWhite],
    items: [
  ...
  },
  {
    ...
    images: [floralBlossomArt, leopardBowFrench, redFrenchFloral, whiteBowFrenchSquare],
    items: [
